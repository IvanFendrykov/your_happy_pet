        ...
        {ourFriends.map((ourFriend, index) => (
          <ListElement key={ourFriend._id}>
            <Link href={ourFriend.url}>
              ...
              <ElementContainer>
                <Image
                  src={ourFriend.imageUrl ? ourFriend.imageUrl : reserveImg}
                  alt={ourFriend.title}
                />
                <CartList>
                  <li>
                    <H>Time:</H>
                    <BTN onClick={() => btnChange(index)}>
                      {!modalStates[index] ? 'Show' : 'Hide'}
                    </BTN>
                    {modalStates[index] ? (
                      <TimeList>
                  ...
                  <li>
                    ...
                    <Url
                      href={
                        ourFriend.email
                          ? `mailto:${ourFriend.email}`
                          : ourFriend.url
                      }
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      {ourFriend.email ? ourFriend.email : reserveMessage}
                    </Url>
                  </li>
                  <li>
                    <H>Phone:</H>
                    <Url
                      ...
                      rel="noopener noreferrer"
                    >
                      {ourFriend.phone ? ourFriend.phone : reserveMessage}
                    </Url>
                  </li>
                </CartList>
              </ElementContainer>

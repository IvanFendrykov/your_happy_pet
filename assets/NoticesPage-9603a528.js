import{j as e,v as c,r as l,i as h,N as H,x as O}from"./index-fe8135ac.js";const T=()=>e.jsxs("form",{children:[e.jsx("input",{type:"text"}),e.jsx("button",{type:"submit"})]}),Q=c.form`
  display: flex;
  column-gap: 12px;
`,F=c.input`
  display: none;

...
`,Q=l.button`
  ...
  align-items: center;
  gap: 12px;
`,d="https://ivanfendrykov.github.io/your_happy_pet/assets/symbol-defs-38f9fd8c.svg",Z=l.form``,ee=l.div`
  display: flex;
  align-items: center;
  flex-direction: column;
  gap: 20px;

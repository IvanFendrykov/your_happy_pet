...
`;n.button`
  ...
  ${""}
`;const Pe=()=>e.jsxs(Be,{children:[e.jsx(Ee,{type:"text",placeholder:"Search"}),e.jsx(Le,{type:"submit",children:e.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",children:e.jsx("use",{xlinkHref:`${j}#search`})})})]}),{fonts:oe,fontSizes:ie,colors:se}=M,Me=n.form`
  display: flex;
  flex-wrap: wrap;
  gap: 12px;
`,q=n.input`
...
`,Ye=document.getElementById("modal-root"),ae=({toggleModal:t,children:i})=>{ye().pathname.includes("notices"),a.useEffect(()=>{const l=p=>{p.code==="Escape"&&t()};return document.addEventListener("keydown",l),()=>{document.removeEventListener("keydown",l)}},[t]);const o=l=>{l.target===l.currentTarget&&t()};return we.createPortal(e.jsx(e.Fragment,{children:e.jsx(Ge,{onClick:o,children:e.jsxs(He,{children:[e.jsx(We,{type:"button",onClick:t,children:e.jsx(De,{size:22,color:"#54ADFF"})}),i]})})}),Ye)};ae.propTypes={toggleModal:V.func.isRequired,children:V.node.isRequired};const Ue=k.div`
  position: fixed;
  top: 50%;
  left: 50%;
...
`;n.button`
  ...
  gap: 12px;
  letter-spacing: 0.04em;
`;const Dt=({notice:t,onClose:i})=>{const r=J(),o=L($e),[l,p]=a.useState(!1),[h,d]=a.useState(!1),g=L(b=>b.auth.isLoggedIn),m=()=>{o.isLoggedIn?r(Q({noticeId:t._id,token:o.token})):ke.error("You need to sign in")},z=b=>{const E=new Date(b),O=new Date;return new Date(O-E).getFullYear()-1970},S=()=>{p(b=>!b)},F=()=>{d(b=>!b)};return e.jsx(e.Fragment,{children:e.jsx(ut,{onClick:F,children:e.jsxs(mt,{children:[e.jsx(jt,{type:"button",onClick:()=>i(),children:e.jsx(ft,{size:22,color:"#54ADFF"})}),e.jsxs(wt,{children:[e.jsx(yt,{children:e.jsx(bt,{src:t.image,alt:"dog"})}),e.jsxs("div",{style:{width:"321px",padding:"0 12px"},children:[e.jsx(vt,{children:t.title}),e.jsxs("div",{style:{display:"flex",gap:"50px"},children:[e.jsxs(X,{children:[e.jsx(x,{children:"Name: "}),e.jsx(x,{children:"Age: "}),e.jsx(x,{children:"Breed: "}),t.price&&e.jsx(x,{children:"Price: "}),e.jsx(x,{children:"Place: "}),e.jsx(x,{children:"The sex: "}),e.jsx(x,{children:"Email: "}),e.jsx(x,{children:"Phone: "})]}),e.jsxs(X,{children:[e.jsx(x,{children:t.name}),e.jsx(x,{children:z(t.birthDay)}),e.jsx(x,{children:t.typeOfPet}),t.price&&e.jsxs(x,{children:[" ",t.price]}),e.jsx(x,{children:t.location}),e.jsx(x,{children:t.gender}),e.jsx(x,{children:e.jsx("a",{style:{color:"#FFC107",textDecoration:"underline"},href:`mailto:${t.email}`,children:t.email})}),e.jsx(x,{style:{color:"#FFC107",textDecoration:"underline"},children:e.jsx("a",{style:{color:"#FFC107",textDecoration:"underline"},href:`tel:${t.phone}`,children:t.phone})})]})]})]})]}),e.jsxs($t,{children:["Commentaries: ",t.comments]}),e.jsxs(Ct,{children:[e.jsxs(Ft,{type:"button",onClick:()=>{m(t._id),S()},children:[e.jsx("span",{children:o.isFavorite?"Remove":"Add"}),e.jsx(ht,{size:20})]}),e.jsx(kt,{href:`tel:${t.phone}`,children:"Contact"})]}),l&&!g&&e.jsx(re,{toggleUnauthorizeModal:S})]})})})},Ot=()=>{const[t,i]=a.useState(null),r=K(),[o,l]=a.useState(""),[p,h]=a.useState({age:"any age",gender:""}),[d,g]=a.useState([""]),[m,z]=a.useState(null),[S,F]=a.useState(!1),[b,E]=a.useState(!1),O=J(),T=L(s=>s.auth.token),$=L(s=>s.auth.isLoggedIn),N=s=>{l(s)},R=s=>{h(s)},A=s=>{const u=new Date(s),f=new Date;return new Date(f-u).getFullYear()-1970},xe=(s,u)=>{const f=A(s.petBirthday);return{upToOne:f<1,upToTwo:f<2,fromTwo:f>=2,anyAge:!0}[u]},fe=s=>{console.log(s),O(Q({token:T,noticeId:s}))},he=async s=>{console.log("onDeleteFromFavourite"+s);try{(await U.delete(`https://happy-pets-rest-api.onrender.com/api/notices/${s}`,{headers:{Authorization:`Bearer ${T}`}})).status===200&&i(f=>f.filter(I=>I._id!==s))}catch(u){return console.error("Error fetching user:",u),null}},ge=s=>{z(t.find(u=>u._id===s))},ue=()=>{z(null)};if(a.useEffect(()=>{(async()=>{try{const u=await U.get(`https://happy-pets-rest-api.onrender.com/api/notices?${o&&"category="+o}`);i(u.data.data.docs)}catch{return null}F(!0)})()},[o,p]),a.useEffect(()=>{if(t){const u=t.filter(f=>(!o||f.category===o)&&xe(f,p.age)&&(!p.gender||f.sex===p.gender)).map(f=>{const I=A(f.birthDay),Y=`${I} year${I!==1?"s":""}`;return{...f,age:Y}});g(u),F(!0)}},[t,o,p]),!S)return e.jsx(Fe,{});const me=()=>{$?r("/add-pet"):W()},W=()=>{E(s=>!s)};return e.jsxs("div",{children:[e.jsx(lt,{children:"Find your favorite pet"}),e.jsx(Pe,{}),e.jsxs(dt,{children:[e.jsx(_e,{isLoggedIn:$,onChange:N}),e.jsxs(ct,{children:[e.jsx(st,{onChange:R}),e.jsx(xt,{type:"button",onClick:me,children:e.jsxs(pt,{children:["Add pet",e.jsx("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"#fff",children:e.jsx("use",{xlinkHref:`${j}#plus-small-white`})})]})})]})]}),e.jsx(Ce,{petsData:d,isLoggedIn:$,onAddToFavourite:fe,onDelete:he,onLearnMore:ge}),b&&!$&&e.jsx(re,{toggleUnauthorizeModal:W}),m&&e.jsx(Dt,{notice:m,onClose:ue})]})};export{Ot as default};

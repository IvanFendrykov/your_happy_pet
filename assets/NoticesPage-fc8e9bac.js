import{j as e,w as c,r as l,i as h,N as H,y as O}from"./index-652fb41e.js";const T=()=>e.jsxs("form",{children:[e.jsx("input",{type:"text"}),e.jsx("button",{type:"submit"})]}),Q=c.form`
  display: flex;
  column-gap: 12px;
`,F=c.input`
  display: none;

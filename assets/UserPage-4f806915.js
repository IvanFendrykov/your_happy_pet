...
`;function Pt({pets:e,onDelete:a}){return t.jsxs(Contejner,{style:{position:"relative",zIndex:5},children:[t.jsxs(Dt,{to:"/add-pet",children:[t.jsx(jt,{style:{stroke:"#fff"}}),t.jsx("span",{children:"Add pet"})]}),e&&e.length>0?e.map(p=>t.jsx(Vt,{pet:p,onDelete:a},p._id)):t.jsx(Ft,{children:"You didnt added any pets!"})]})}const Bt=i.div`
  margin-left: auto;
  margin-right: auto;
  width: 320px;
  padding-top: 40px;

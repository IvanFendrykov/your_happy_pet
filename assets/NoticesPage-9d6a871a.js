import{g as ue,x as n,z as N,j as e,i as w,u as V,r,s as k,f as me,h as be,A as ye,N as we,G as q,c as Q,b as L,C as je,n as ve,D as X,E as $e,a as T}from"./index-cd17edaa.js";import{S as ke}from"./cross-smal-37e881f7.js";var K={exports:{}},Fe="SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED",Ce=Fe,ze=Ce;function Z(){}function J(){}J.resetWarningCache=Z;var Se=function(){function t(o,l,h,g,d,f){if(f!==ze){var y=new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");throw y.name="Invariant Violation",y}}t.isRequired=t;function i(){return t}var s={array:t,bigint:t,bool:t,func:t,number:t,object:t,string:t,symbol:t,any:t,arrayOf:i,element:t,elementType:t,instanceOf:i,node:t,objectOf:i,oneOf:i,oneOfType:i,shape:i,exact:i,checkPropTypes:J,resetWarningCache:Z};return s.PropTypes=s,s};K.exports=Se();var De=K.exports;const W=ue(De),{fonts:Oe}=N,Ie=n.form`
  margin-top: 40px;
  margin-inline: auto;
  margin-bottom: 43px;
  max-width: 608px;
